  ...
  return (
    <>
      <section className="relative mt-20 lg:mt-10">
        ...
        <h1 className="flex justify-start col-span-6 text-5xl font-extrabold lg:relative lg:-tracking-[.5rem] lg:text-9xl bg-clip-text text-transparent bg-gradient-to-r from-[var(--gradient-start)] via-[var(--gradient-via)] to-[var(--gradient-end)] ml-3 sm:ml-[212px] lg:leading-[100px] pt-8 uppercase">
          Información
          <br />  
        </h1>
