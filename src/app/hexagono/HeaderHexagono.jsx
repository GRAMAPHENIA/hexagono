...
const HeaderInfo = () => {
  return (
    <>
      ...
      <p className="text-sm top-[22px] left-[22px] lg:text-xl lg:top-[-30px] lg:left-[25px] font-extralight col-span-5 sm:ml-52 sm:w-80 text-[--font-light] text-amber-100 pt-3">
