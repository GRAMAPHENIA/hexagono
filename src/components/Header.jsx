...
const Header = () => {
  return (
    <>
      <p className="text-sm absolute top-[165px] left-[22px] lg:text-xl lg:top-[156px] lg:left-[148px] font-extralight uppercase col-span-5 sm:ml-48 sm:w-80 text-[--font-light] text-amber-100">
        concepto hexágono
      </p>
