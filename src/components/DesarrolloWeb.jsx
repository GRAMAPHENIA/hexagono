      ...
      <section className="my-20">
        <figure className="flex flex-col items-center">
          <Image
            ...
            className="py-10"
          />
          <p className="text-[var(--font-light)] text-xl font-extralight text-center max-w-[920px] pb-10">
        ...
        <section className="grid lg:grid-cols-5 justify-center gap-8 pt-10">
          {caracteristicas.map(({ titulo, descripcion, imagen }, index) => (
            <div
              className="col-span-1 flex justify-center items-center bg-[var(--font-semi-light)] p-2 py-2 rounded-xl sombra-inactiva"
              key={index}
            >
        ...
        <div className="flex justify-center my-20">
          <button className="col-span-5 flex justify-center items-center text-[var(--font-light)] bg-[var(--gradient-end)] px-8 py-4 rounded-full sombra">
            Saber Más
          </button>
        </div>
      </section>
